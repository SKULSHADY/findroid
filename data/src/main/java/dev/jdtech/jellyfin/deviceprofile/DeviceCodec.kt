...
import dev.jdtech.jellyfin.deviceprofile.CodecHelpers.getAudioCodec
import dev.jdtech.jellyfin.deviceprofile.CodecHelpers.getAudioProfile
import dev.jdtech.jellyfin.deviceprofile.CodecHelpers.getVideoCodec
import dev.jdtech.jellyfin.deviceprofile.CodecHelpers.getVideoLevel
import dev.jdtech.jellyfin.deviceprofile.CodecHelpers.getVideoProfile
        ...
        fun mergeCodec(codecToMerge: Audio): Audio = Audio(
            ...
            maxSampleRate = when {
                maxSampleRate != null -> when {
                    codecToMerge.maxSampleRate != null -> max(
                        maxSampleRate,
                        codecToMerge.maxSampleRate
                    )
